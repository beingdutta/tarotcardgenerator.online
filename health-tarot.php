<?php
$pageTitle = 'Health Tarot Card Generator | Free Wellness Reading';
$pageDescription = 'Use our free health tarot card generator for insights into your well-being. This random tarot card generator provides a one-card reading for your wellness journey.';
$pageKeywords = 'health tarot, tarot for health, wellness tarot reading, tarot card generator, random tarot card generator';
$ogImage = 'https://tarotcardgenerator.online/assets/og-health.jpg';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="bg-black">
    ...
    <main class="container mx-auto px-4 py-8 md:py-12">
        <div class="lg:-translate-x-24"> <!-- This new wrapper shifts the content left on large screens -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 items-start">
                ...
                <div id="left-column" class="flex flex-col items-center md:items-end md:pr-12">
                    <h2 id="card-name-heading" class="font-serif text-xl md:text-2xl text-amber-200 mb-6 w-full max-w-[15rem] text-center">Health Tarot</h2>
                    
                    <!-- Card Image -->
                    <img id="tarot-card-image" src="/assets/backface/health.png" alt="Tarot Card Back" class="cursor-pointer max-w-[15rem] h-auto rounded-lg border-2 border-amber-200/30 shadow-lg shadow-amber-200/5 transition-all duration-300 hover:shadow-amber-200/20 hover:border-amber-200/60">
                ...
                <div id="right-column" class="mt-8 md:mt-0 md:pt-12">
                    <div class="prose prose-invert prose-p:text-gray-300 prose-headings:text-amber-200 prose-headings:font-serif max-w-none">
                        <h3 class="text-2xl">A reading for your well-being.</h3>
                        <p>Take a deep breath and center yourself. Focus on your physical and mental state, and prepare to receive the wisdom the cards hold for you.</p>
                        ...
                        <ul class="list-none p-0 mt-2 space-y-3">
                            <li class="flex items-start">
                                ...
                                <span class="text-amber-200">Focus your energy on your health and think about your intentions for well-being.</span>
                            </li>
                            <li class="flex items-start">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-amber-200/50 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                                <span class="text-amber-200">You can only draw one health card per day. This reading is your unique message for the next 24 hours.</span>
                            </li>
                            <li class="flex items-start">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-amber-200/50 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (!isLocalhost) {
                const lastDrawTimestamp = getCookie("healthDrawTimestamp");
            ...
            function drawCard() {
                ...
                setTimeout(() => {
                    if (!isLocalhost) {
                        ...
                        setCookie("healthDrawTimestamp", expirationDate.getTime(), 1);
                    }
