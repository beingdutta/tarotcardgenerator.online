<?php
$pageTitle = 'Love Tarot Card Generator | Free Random Reading for Relationships';
$pageDescription = 'Use our love tarot card generator for a free one-card reading. This random tarot card generator offers instant insight into your romantic life, relationships, and matters of the heart.';
$pageKeywords = 'love tarot, free love tarot reading, tarot card generator love, relationship tarot, one card tarot love';
$ogImage = 'https://tarotcardgenerator.online/assets/og-love.jpg';
?>
<!DOCTYPE html>
<html lang="en">
<head>
